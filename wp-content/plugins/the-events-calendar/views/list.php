...
<div id="primary">
	<div id="tec-content" class="upcoming">
		<div id='tec-events-calendar-header' class="clearfix">
			<h2 class="entry-title"><?php _e('Upcoming Events', $spEvents->pluginDomain) ?></h2>
		...
		<?php while ( have_posts() ) : the_post(); ?>
				...
				<div id="post-<?php the_ID() ?>" class="tec-event post clearfix<?php echo $alt ?>">
					...
					<h2 class="event-day"><?php echo the_event_start_date( null, false ); ?></h4>
							        <?php endif; ?>
						<?php the_title('<h3 class="entry-title"><a href="' . get_permalink() . '" title="' . the_title_attribute('echo=0') . '" rel="bookmark">', '</a></h2>'); ?>
