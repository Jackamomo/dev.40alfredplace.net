...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<footer class="entry-meta">
		<?php
			...
			if ( '' != $tag_list ) {
				$utility_text = __( ' in %1$s and tagged %2$s. <span class="sep"> by </span> <span class="author vcard"><a class="url fn n" href="%4$s" title="%5$s">%6$s</a></span> by <span class="sep"> by </span> <span class="author vcard"><a class="url fn n" href="%4$s" title="%5$s">%6$s</a></span>', 'toolbox' );
			} else {
				$utility_text = __( ' in %1$s <a href="%3$s"', 'toolbox' );
			}
			printf(
				$utility_text,
